...
import { CheckboxField } from "@/shared/components/shared/CheckboxField";
import { CheckCircle, Info, ChevronDown, ChevronUp } from "lucide-react";
import { calculateTotalPayable, getAgeBandSlab, ADVANCE_DFC_EXPLANATION } from "@/shared/utils/contributionCalculator";
import { RegistrationFormData, RegistrationStep } from "@/domains/public/registration/models/view/registration";
